...
app = Flask(__name__)
app.secret_key = "bootcampcrypto"  #this is my customized key for session sec

# Configuration for Firebase
config = {
    "apiKey": "AIzaSyD-GdjuQwqBlT48ysbW3g023kztL9PEQYU",    #this key is ok to be exposed
    "authDomain": "add8474c155291931e21688b027bf9.firebaseapp.com", #projID.firebaseapp.com
    "databaseURL": "https://add8474c155291931e21688b027bf9-default-rtdb.firebaseio.com/",
    "storageBucket": "add8474c155291931e21688b027bf9.appspot.com"   #projID.appspot.com
        }
# Initialize Firebase
...
@app.route('/about')
def about():
    return render_template('about.html')  # Points to the new HTML template
